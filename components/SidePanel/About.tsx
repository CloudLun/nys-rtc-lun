...
const About = ({ expand, legislationsClickHandler }: Props) => {
    ...
    return (
        <div className={`flex flex-col px-[30px] pt-[10.5px] pb-[20px] text-rtc_navy ${expand["About"] ? "h-[calc(100vh-112px-220px)] bg-white" : "h-[45px] bg-background_blue"} border-y-[1px] border-grey_1 overflow-y-scroll`}>
                ...
                <div className="flex items-start gap-[36px] my-[16px]">
                    <h2 className={`pb-[3px] font-semibold text-title border-b-2  ${selectedContent === "intro" ? "text-rtc_navy  border-rtc_navy" : "text-grey_1 border-white "}  cursor-pointer`} onClick={() => contentClickHandler("intro")}>the HCMC! Campaign Legislation Map</h2>
