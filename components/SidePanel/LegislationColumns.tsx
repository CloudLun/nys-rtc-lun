...
const LegislationColumns = ({ legislation, title, name, number, content, expand, legislationsClickHandler }: Props) => {
    ...
    return (
        <div className={`px-[30px] pt-[10.5px] pb-[20px] text-rtc_navy ${expand ? " bg-white" : "h-[45px] bg-background_blue"} border-t-[1px] border-grey_1  overflow-y-hidden cursor-pointer`} onClick={legislationsClickHandler}>
